...
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton cmdSegundaParte 
...
'***********************************************
'ESO ERA PARA EL CIRCULO NOOO PARA RETIRADOS
'dic 2013 NO LO USO MAS. SUSTITUIDA POR D:\Dropbox\Google Drive\ARCHIVOS\Proy\vb CP Listado\2013Listado.vbp
...
'==================================
'Crea el archivo R\515.txt para ser enviado a jefatura
...
Do While Not adoExced.EOF
            'Hay un error: el ultimo renglon tiene ceros
...
Close #1
Mensaje3 "Terminado"
Mensaje3 "Borrar ultima linea de 515.txt"
End Sub
